...
import com.dacri.security.Authorities;
import com.dacri.security.CustomAuthenticationEntryPoint;
import com.dacri.security.CustomLogoutSuccessHandler;
	...
	protected static class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
		...
		public void configure(HttpSecurity http) throws Exception {
			http.exceptionHandling().authenticationEntryPoint(customAuthenticationEntryPoint).and().logout()
					...
					.frameOptions().disable().and().authorizeRequests().antMatchers("/hello/**").permitAll()
